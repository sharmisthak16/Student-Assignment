...
AddStudentModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,      // isOpen should be a boolean and required
  onRequestClose: PropTypes.func.isRequired,  // onRequestClose should be a function and required
};
